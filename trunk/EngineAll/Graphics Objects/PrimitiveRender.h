...
public:
    ...
    virtual void DrawPolygon(Bitmap &B, ZBuffer &Z, MeshVertex *Vertices, int VertexCount) = 0;
...
public:
    ...
    void DrawPolygon(Bitmap &B, ZBuffer &Z, MeshVertex *Vertices, int VertexCount);
