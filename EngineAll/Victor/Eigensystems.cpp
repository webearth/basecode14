...
int RNP::Eigensystem(size_t n, std::complex<double>* A, size_t lda, std::complex<double>* eval, std::complex<double>* evec, size_t ldvec, unsigned int max_iter, unsigned int *nrot){
